...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // actualsList
      char dummy17[sizeof (std::list<a_lang::ExpNode *> *)];

      // maybeFormals
      // formalList
      char dummy18[sizeof (std::list<a_lang::FormalDeclNode *> *)];

      // stmtList
      char dummy19[sizeof (std::list<a_lang::StmtNode *> *)];
    };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_type = 53,                             // type
        S_primType = 54,                         // primType
        S_fnDecl = 55,                           // fnDecl
        S_maybeFormals = 56,                     // maybeFormals
        S_formalList = 57,                       // formalList
        S_formalDecl = 58,                       // formalDecl
        S_stmtList = 59,                         // stmtList
        S_blockStmt = 60,                        // blockStmt
        S_stmt = 61,                             // stmt
        S_exp = 62,                              // exp
        S_callExp = 63,                          // callExp
        S_actualsList = 64,                      // actualsList
        S_term = 65,                             // term
        S_loc = 66,                              // loc
        S_name = 67                              // name
      };
