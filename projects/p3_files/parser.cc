...
#line 137 "parser.cc"
    ...
    , value ()
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_classTypeDecl: // classTypeDecl
        value.copy< a_lang::ClassDeclNode* > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_actualList: // actualList
        value.copy< std::vector<a_lang::ExpNode*> > (YY_MOVE (that.value));
        break;
  ...
  Parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_classTypeDecl: // classTypeDecl
        value.move< a_lang::ClassDeclNode* > (YY_MOVE (s.value));
        break;
      ...
      case symbol_kind::S_actualList: // actualList
        value.move< std::vector<a_lang::ExpNode*> > (YY_MOVE (s.value));
        break;
    ...
    : super_type (YY_MOVE (that.state))
  {
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_classTypeDecl: // classTypeDecl
        value.YY_MOVE_OR_COPY< a_lang::ClassDeclNode* > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_actualList: // actualList
        value.YY_MOVE_OR_COPY< std::vector<a_lang::ExpNode*> > (YY_MOVE (that.value));
        break;
    ...
    : super_type (s)
  {
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_classTypeDecl: // classTypeDecl
        value.move< a_lang::ClassDeclNode* > (YY_MOVE (that.value));
        break;
      ...
      case symbol_kind::S_actualList: // actualList
        value.move< std::vector<a_lang::ExpNode*> > (YY_MOVE (that.value));
        break;
  ...
  Parser::stack_symbol_type::operator= (const stack_symbol_type& that)
  {
    ...
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_classTypeDecl: // classTypeDecl
        value.copy< a_lang::ClassDeclNode* > (that.value);
        break;
      ...
      case symbol_kind::S_actualList: // actualList
        value.copy< std::vector<a_lang::ExpNode*> > (that.value);
        break;
  ...
  Parser::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    ...
    switch (that.kind ())
    {
      ...
      case symbol_kind::S_classTypeDecl: // classTypeDecl
        value.move< a_lang::ClassDeclNode* > (that.value);
        break;
      ...
      case symbol_kind::S_actualList: // actualList
        value.move< std::vector<a_lang::ExpNode*> > (that.value);
        break;
  ...
  yyreduce:
      ...
      switch (yyr1_[yyn])
    {
      ...
      case symbol_kind::S_classTypeDecl: // classTypeDecl
        yylhs.value.emplace< a_lang::ClassDeclNode* > ();
        break;
      ...
      case symbol_kind::S_actualList: // actualList
        yylhs.value.emplace< std::vector<a_lang::ExpNode*> > ();
        break;
...
#line 174 "a.yy"
			...
			yystack_[1].value.as < a_lang::VarDeclNode* > ()->m_PrintSemicolon = true;
		  }
#line 1532 "parser.cc"
    break;
...
#line 179 "a.yy"
                  {
			yylhs.value.as < a_lang::DeclNode* > () = yystack_[0].value.as < a_lang::ClassDeclNode* > ();
		  }
#line 1540 "parser.cc"
    break;
...
#line 217 "a.yy"
                  {
			auto classType = new ClassTypeNode(yystack_[0].value.as < a_lang::IDNode* > ()->pos(), yystack_[0].value.as < a_lang::IDNode* > ());
			yylhs.value.as < a_lang::TypeNode* > () = new RefTypeNode(yystack_[1].value.as < a_lang::Token * > ()->pos(), classType);
		  }
#line 1608 "parser.cc"
    break;
...
#line 240 "a.yy"
                  {
			yylhs.value.as < a_lang::ClassDeclNode* > () = new ClassDeclNode(yystack_[6].value.as < a_lang::IDNode* > ()->pos(), yystack_[6].value.as < a_lang::IDNode* > ());
			yylhs.value.as < a_lang::ClassDeclNode* > ()->AddDecls(yystack_[2].value.as < std::vector<a_lang::DeclNode*> > ());
...
#line 247 "a.yy"
			...
			yystack_[1].value.as < a_lang::VarDeclNode* > ()->m_PrintSemicolon = true;
			yylhs.value.as < std::vector<a_lang::DeclNode*> > ().push_back(yystack_[1].value.as < a_lang::VarDeclNode* > ());
...
#line 255 "a.yy"
                  {
			yylhs.value.as < std::vector<a_lang::DeclNode*> > () = std::vector<DeclNode*>();
			yylhs.value.as < std::vector<a_lang::DeclNode*> > ().insert(yylhs.value.as < std::vector<a_lang::DeclNode*> > ().end(), yystack_[1].value.as < std::vector<a_lang::DeclNode*> > ().begin(), yystack_[1].value.as < std::vector<a_lang::DeclNode*> > ().end());
			yylhs.value.as < std::vector<a_lang::DeclNode*> > ().push_back(yystack_[0].value.as < a_lang::FnDeclNode* > ());
		  }
#line 1672 "parser.cc"
    break;
...
#line 310 "a.yy"
                  {
			auto pos = yystack_[1].value.as < a_lang::StmtListNode* > ()->pos() == nullptr ? yystack_[0].value.as < a_lang::StmtNode* > ()->pos() : yystack_[1].value.as < a_lang::StmtListNode* > ()->pos();
			yylhs.value.as < a_lang::StmtListNode* > () = new StmtListNode(pos, true);
			yylhs.value.as < a_lang::StmtListNode* > ()->AddChildren(yystack_[1].value.as < a_lang::StmtListNode* > ()->m_Children);
			yylhs.value.as < a_lang::StmtListNode* > ()->AddChild(yystack_[0].value.as < a_lang::StmtNode* > ());
		  }
#line 1763 "parser.cc"
    break;
...
#line 318 "a.yy"
                  {
			yylhs.value.as < a_lang::StmtNode* > () = new WhileStmtNode(yystack_[6].value.as < a_lang::Token * > ()->pos(), yystack_[4].value.as < a_lang::ExpNode* > (), yystack_[1].value.as < a_lang::StmtListNode* > ()->m_Children);
		  }
#line 1771 "parser.cc"
    break;
...
#line 322 "a.yy"
                  {
			auto x = new IfStmtNode(yystack_[6].value.as < a_lang::Token * > ()->pos(), 0, yystack_[4].value.as < a_lang::ExpNode* > ());
			x->AddStmts1(yystack_[1].value.as < a_lang::StmtListNode* > ()->m_Children);
		  	yylhs.value.as < a_lang::StmtNode* > () = x;
		  }
#line 1781 "parser.cc"
    break;
...
#line 328 "a.yy"
                  {
			auto x = new IfStmtNode(yystack_[10].value.as < a_lang::Token * > ()->pos(), 1, yystack_[8].value.as < a_lang::ExpNode* > ());
			x->AddStmts1(yystack_[5].value.as < a_lang::StmtListNode* > ()->m_Children);
			x->AddStmts2(yystack_[1].value.as < a_lang::StmtListNode* > ()->m_Children);
			yylhs.value.as < a_lang::StmtNode* > () = x;
		  }
#line 1792 "parser.cc"
    break;
...
#line 340 "a.yy"
                  {
			yylhs.value.as < a_lang::StmtNode* > () = new AssignStmtNode(yystack_[2].value.as < a_lang::LocNode* > ()->pos(), yystack_[2].value.as < a_lang::LocNode* > (), yystack_[0].value.as < a_lang::ExpNode* > ());
		  }
#line 1808 "parser.cc"
    break;
...
#line 348 "a.yy"
                  {
			yylhs.value.as < a_lang::StmtNode* > () = new PostDecStmtNode(yystack_[1].value.as < a_lang::LocNode* > ()->pos(), yystack_[1].value.as < a_lang::LocNode* > ());
		  }
#line 1824 "parser.cc"
    break;
...
#line 352 "a.yy"
                  {
			yylhs.value.as < a_lang::StmtNode* > () = new PostIncStmtNode(yystack_[1].value.as < a_lang::LocNode* > ()->pos(), yystack_[1].value.as < a_lang::LocNode* > ());
		  }
#line 1832 "parser.cc"
    break;
...
#line 356 "a.yy"
                  {
			auto x = new ToConsoleStmtNode(yystack_[1].value.as < a_lang::Token * > ()->pos());
			x->m_Exp = yystack_[0].value.as < a_lang::ExpNode* > ();
			yylhs.value.as < a_lang::StmtNode* > () = x;
		  }
#line 1842 "parser.cc"
    break;
...
#line 362 "a.yy"
                  {
			auto x = new FromConsoleStmtNode(yystack_[1].value.as < a_lang::Token * > ()->pos());
			x->m_Loc = yystack_[0].value.as < a_lang::LocNode* > ();
			yylhs.value.as < a_lang::StmtNode* > () = x;
		  }
#line 1852 "parser.cc"
    break;
...
#line 376 "a.yy"
                  {
			yylhs.value.as < a_lang::StmtNode* > () = new ReturnStmtNode(yystack_[0].value.as < a_lang::Token * > ()->pos(), nullptr);
		  }
#line 1876 "parser.cc"
    break;
...
#line 457 "a.yy"
                  {
			yylhs.value.as < a_lang::CallExpNode* > () = new CallExpNode(yystack_[2].value.as < a_lang::LocNode* > ()->pos(), yystack_[2].value.as < a_lang::LocNode* > ());
		  }
#line 2018 "parser.cc"
    break;
...
#line 461 "a.yy"
                  {
			yylhs.value.as < a_lang::CallExpNode* > () = new CallExpNode(yystack_[3].value.as < a_lang::LocNode* > ()->pos(), yystack_[3].value.as < a_lang::LocNode* > ());
			yylhs.value.as < a_lang::CallExpNode* > ()->AddExpressions(yystack_[1].value.as < std::vector<a_lang::ExpNode*> > ());
		  }
#line 2027 "parser.cc"
    break;
...
#line 467 "a.yy"
                  {
			yylhs.value.as < std::vector<a_lang::ExpNode*> > () = {yystack_[0].value.as < a_lang::ExpNode* > ()};
		  }
#line 2035 "parser.cc"
    break;
...
#line 471 "a.yy"
                  {
			yylhs.value.as < std::vector<a_lang::ExpNode*> > () = std::vector<ExpNode*>();
			yylhs.value.as < std::vector<a_lang::ExpNode*> > ().insert(yylhs.value.as < std::vector<a_lang::ExpNode*> > ().end(), yystack_[2].value.as < std::vector<a_lang::ExpNode*> > ().begin(), yystack_[2].value.as < std::vector<a_lang::ExpNode*> > ().end());
			yylhs.value.as < std::vector<a_lang::ExpNode*> > ().push_back(yystack_[0].value.as < a_lang::ExpNode* > ());
		  }
#line 2045 "parser.cc"
    break;
...
#line 502 "a.yy"
			...
			yylhs.value.as < a_lang::ExpNode* > ()->m_InsideParentheses = true;
		  }
#line 2102 "parser.cc"
    break;
...
#line 512 "a.yy"
                  {
			yylhs.value.as < a_lang::LocNode* > () = new LocNode(yystack_[0].value.as < a_lang::IDNode* > ()->pos(), yystack_[0].value.as < a_lang::IDNode* > (), nullptr);
		  }
#line 2118 "parser.cc"
    break;
...
#line 516 "a.yy"
                  {
			yylhs.value.as < a_lang::LocNode* > () = new LocNode(yystack_[2].value.as < a_lang::LocNode* > ()->pos(), yystack_[2].value.as < a_lang::LocNode* > (), yystack_[0].value.as < a_lang::IDNode* > ());
		  }
#line 2126 "parser.cc"
    break;
...
#undef YYCASE_
  ...
  Parser::yyrline_[] =
  {
       0,   156,   156,   162,   169,   173,   178,   182,   187,   193,
     197,   203,   208,   212,   216,   221,   226,   230,   234,   239,
     246,   254,   261,   265,   273,   276,   281,   286,   293,   299,
     302,   309,   317,   321,   327,   335,   339,   343,   347,   351,
     355,   361,   367,   371,   375,   381,   386,   391,   396,   401,
     406,   411,   416,   421,   426,   431,   436,   441,   446,   451,
     456,   460,   466,   470,   477,   481,   485,   489,   493,   497,
     501,   506,   511,   515,   520
  };
